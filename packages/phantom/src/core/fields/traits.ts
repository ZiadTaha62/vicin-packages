import type { __Phantom, __Traits } from '../symbols';
...
export namespace TraitsCore {
  ...
  export type OfIfExists<Trait extends string | symbol> = [Trait] extends [never] ? {} : Of<Trait>;
  ...
  export type HasTraits<T, Tr extends string | symbol = string | symbol> = T extends {
